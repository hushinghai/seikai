  ...
  <div class="with-persistent-nav" id="main_content">
    <nav class="btn-group g-grid g-group">
      <div class="g-cell g-cell-1-1 g-cell-md-6-12 l-block-2 l-align-center-sm">
        <span class="text-heading-epic main-heading" data-automation="event-name-display">Edit Event</span>
      </div>
    ...
    <div class="clrfix" id="content">
      <form accept-charset="utf-8" action="{{ URL::to('user/editevent')}}" class="responsive-form g-grid g-group" enctype="multipart/form-data" id=
          ...
          <div class="clrfix page visible active" id="main_page">
            <div id="main_wrapper">
                ...
                <div class="g-vertical-group g-cell-md-1-1 g-cell-lg-8-12 g-offset-lg-1-12 module_content l-block-2" id="event_details_content">
                  <div id="event_details_title">
                    <div class="g-cell g-cell-1-1">
                      <label class="responsive-form__label--primary editheading" for="id_group-details-name">Event title <span class="required">*</span></label>
                    </div>
                    ...
                    <div class="l-block-1 g-cell g-cell-1-1">
                      <div class="inputtext">
                        ...
                        "name" placeholder="Give it a short distinct name" type="text" value="{{$event->name}}">
                  ...
                  <div class="g-cell g-cell-1-1 l-block-3">
                    <label class="editheading responsive-form__label--primary" for="location-name-input">City</label>
                  </div>
                  <div class="l-block-1 g-cell g-cell-1-1">
                        
                        <label class="editlabels" id="city_autocomplete" name="city" >{{$event->city}}</label>
                    </div>
                  <input id="lat" name="lat" type="hidden" value=""> 
                  <input id="lng" name="lng" type="hidden" value="">

                  <div class="g-cell g-cell-1-1 l-block-3">
                    <label class="editheading responsive-form__label--primary" for="location-name-input">Venue</label>
                  </div>  
                <div class="l-block-1 g-cell g-cell-1-1">
                  <textarea class="span8 input-xlarge focused" rows="3" name="venue">{{$event->venue}}</textarea>
                </div>
                  ...
                  <div class="l-block-3" id="event_details_date">
                    <div>
                      ...
                      <div class="datetime_input start_date g-cell l-block-1">
                        <label class="editheading responsive-form__label--primary">Start Date</label>

                        <div class="l-block-1">
                          
                          <label name="start_date" class="editlabels" id="start_date">{{$event->start_date}}</label>
                        </div>
                      </div>

                      <div class="datetime_input start_date g-cell l-block-1">
                        <label class="editheading responsive-form__label--primary">Start Time</label>


                        <div class="l-block-1">
                          
                          <label name="start_time" class="editlabels" id="start_time" >{{$event->start_time}}</label>
                        </div>
                      </div>


                      <div class="datetime_input end_date g-cell l-block-1">
                        <label class="editheading responsive-form__label--primary">End Date</label>

                        <div class="l-block-1">
                          <label name="end_date" class="editlabels" id="end_date" >{{$event->end_date}}</label>

                        </div>
                      </div>

                      <div class="datetime_input end_date g-cell l-block-1">
                        <label class="editheading responsive-form__label--primary">End Time</label>

                        <div class="l-block-1">

                           <label name="end_time" class="editlabels" id="end_time" >{{$event->end_time}}</label>
                  ...
                  <div class="l-block-3" id="event_details_logo">
                    <div class="g-cell g-cell-1-1">
                      <label class="editheading responsive-form__label--primary">Event logo</label>

                      @if($event->image_url != null)
                      <br/>
                          <label class="responsive-form__label--primary" style="margin-right: 3%;">Current Logo</label>
                          <img id="organizer_image" style="zoom: 0.2;vertical-align: middle;" class="photo" src="{{URL::to('uploads/event_logos/' .$event->image_url) }}">
                    ...
                    <div class="js-event-logo-uploader" id="event-logo-uploader">
                      <div class="form__logo-upload js-image-upload__form">
                        <input id="logo" name="file" title="Change Logo.. Choose a file" type="file">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="l-block-3" id="event_details_details">
                    <div class="g-cell g-cell-1-1">
                      <label class="editheading responsive-form__label--primary">Event description</label>
                    </div>
                    ...
                    <div class="l-block-1">
                      <div class="g-cell g-cell-1-1">
                        ...
                        "Tell people what&#39;s special about this event" rows="10">{{$event->description}}
</textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="l-block-3" id="event_details_organizer">
                    <div class="g-cell g-cell-1-1">
                      <label class="editheading responsive-form__label--primary">Organizer name</label>
                    </div>
              ...
              <div class="g-group" id="privacy_and_promotion_wrapper">
                <div class="" id="privacy_header">
                  <div class="l-block-6">
                    <div class="g-cell g-cell-1-1 g-cell-lg-7-12 g-cell-md-8-12 g-offset-lg-1-12">
                      <div class="l-media-v-center">
                        <div class="l-media-v-center__row">
                          <span class="ico-box ico--small ico--color-teal ico--color-brand-white">3</span> <span class="text-heading-primary l-padded-h-1">Current
                          tickets</span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="ticketinfo" id="ticket_information_wrapper" style="position: relative;">
            <input name="eid" type="hidden" value="21">
            ...
            <div class="panel_body" id="TicketReg">
              <table border="0" cellpadding="0" cellspacing="0" class="ticket_table" id="ticket_table" width="100%">
                ...
                @foreach($tickets as $tickettype)
                    <tr class="ticket_row" style="font-size:11px;">
                      ...
                      <td nowrap="nowrap">
                       {{$tickettype->seats_left}}
                        ...
                        <td nowrap="nowrap">{{$tickettype->dprice}}</td>
                        <td nowrap="nowrap">{{$tickettype->fees}}</td>

                        <td nowrap="nowrap">{{$tickettype->dfees_type}}</td>
                   @endforeach
                    ...
                    <div class="g-cell g-cell-1-1 g-cell-lg-7-12 g-cell-md-8-12 g-offset-lg-1-12">
                      <div class="l-media-v-center" id="createTicketsl-media-v-center">
                        <div class="l-media-v-center__row" id="createTicketsspan">
                          <span class="ico-box ico--small ico--color-teal ico--color-brand-white">2</span> <span class="text-heading-primary l-padded-h-1">Add More Tickets</span>
                        </div>
                ...
                <div class="" id="privacy_and_promotion_content">
                  <div class="promotion g-group" id="privacy_and_promotion_categories">
                    <div class="g-cell g-cell-12-12 g-cell-md-10-12 g-cell-lg-8-12 g-offset-lg-1-12 l-block-2 select">
                      <label class="editheading responsive-form__label--primary" for="id_group-privacy_and_promotion-primary_category">Event Type<span class=
                    ...
                    <div class="g-cell g-cell-12-12 g-cell-md-10-12 g-cell-lg-8-12 g-offset-lg-1-12 l-block-1">
                      <div class="create_select_time_field custom-select-container clrfix">
                        ...
                        {{ Form::select('eventcat', $category, "$event->category",array('class' => 'span3 select2 ticketfees')) }}
                      </div>
                    ...
                    <div class="g-cell g-cell-12-12 g-cell-md-10-12 g-cell-lg-8-12 g-offset-lg-1-12 l-block-2 select l-block-2">
                      <label class="editheading responsive-form__label--primary" for="id_group-privacy_and_promotion-primary_category">Event Topic<span class=
                      "required is-hidden">*</span></label>
                    </div>
                    ...
                    <div class="g-cell g-cell-12-12 g-cell-md-5-12 g-cell-lg-4-12 g-offset-lg-1-12">
                      <div class="l-block-1">
                        <div class=" create_select_time_field custom-select-container clrfix">
                          ...
                          {{ Form::select('eventtype', $types, "$event->event_type",array('class' => 'span3 select2 ticketfees')) }}
                        </div>
                      </div>
        ...
        <div class="js-publish-callout l-align-center l-block-4 responsive-form">
          <div class="l-padded-h-2 l-padded-v-4" id="starburst">
            ...
            <div class="g-cell g-cell-1-1 btn-group btn-group--responsive" id="next_step_buttons">
              <button class="btn btn--secondary" id="create" type="submit" value="Create">Save</button>
            </div>
          </div>
        </div>
      </form>
